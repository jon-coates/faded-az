      ...
      <div className='max-w-2xl mx-auto px-5 relative z-10'>
        ...
        <div className='text-center mb-8'>
          <motion.h2 
            ...
            className='font-gloock text-3xl md:text-4xl font-bold text-white mb-4'
          >
          ...
          <motion.a 
            ...
            className='inline-block mt-4 px-6 py-3 bg-white text-gray-900 hover:bg-gray-100 font-semibold rounded-lg transition-colors duration-200 shadow-lg'
          >
            Follow @faded_azf
          </motion.a>
        </div>
